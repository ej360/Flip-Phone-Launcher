...
import app.fplauncher.data.Constants
import app.fplauncher.data.Prefs
import app.fplauncher.databinding.ActivityMainBinding
import app.fplauncher.helper.getColorFromAttr
import app.fplauncher.helper.hasBeenDays
import app.fplauncher.helper.hasBeenHours
import app.fplauncher.helper.hasBeenMinutes
import app.fplauncher.helper.isDarkThemeOn
import app.fplauncher.helper.isDaySince
import app.fplauncher.helper.isDefaultLauncher
import app.fplauncher.helper.isEinkDisplay
import app.fplauncher.helper.isOlauncherDefault
import app.fplauncher.helper.isTablet
import app.fplauncher.helper.openUrl
import app.fplauncher.helper.rateApp
import app.fplauncher.helper.resetLauncherViaFakeActivity
import app.fplauncher.helper.setPlainWallpaper
import app.fplauncher.helper.shareApp
import app.fplauncher.helper.showLauncherSelector
import app.fplauncher.helper.showToast
